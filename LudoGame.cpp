...
void init()
{
	glClearColor(1,0.8,0.5,0.0);
  glEnable(GL_DEPTH_TEST);
  glutInitDisplayMode(GLUT_RGBA);
   glutInitWindowPosition(0,0);
  glutInitWindowSize(1355,703);
  glutCreateWindow("HKBK - LUDO - BOARD GAME");
}
...
void about(void)
{
  char *about="\t\t\tHKBK LUDO MATCH IS DRAWN ! \n\n\n\n\n\n\n\n\n\n\n\n\n\n\nQ = QUIT   ENTER = RESTART";
...
void enter_display2()
{
	...
	char *about="PRESS  ENTER  TO  START\n";
  void *en=GLUT_BITMAP_TIMES_ROMAN_24;
...
void main(void)
{
   ...
   glutAddMenuEntry("About LUDO Project",1);
